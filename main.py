...
# 1. 解决 PyInstaller 打包后动态加载 importlib 找不到路径的问题
...
class MainApplication(QMainWindow):
    ...
    def apply_global_theme(self):
        self.setStyleSheet(
            ...
            "QFrame#TopBar { background-color: #0f172a; border-bottom: 1px solid #1e293b; }\n"
            "QFrame#Sidebar { background-color: #0b0f19; border-right: 1px solid #1e293b; }\n"
            "QStackedWidget#WorkArea { background-color: #090d16; }\n"
            "QListWidget#NavList { background: transparent; border: none; outline: none; }\n"
            "QListWidget#NavList::item { background-color: #1e293b; color: #94a3b8; border: 1px solid #1e293b; border-radius: 6px; padding-left: 10px; font-family: 'Microsoft YaHei'; font-size: 12px; }\n"
            "QListWidget#NavList::item:hover { background-color: #0f172a; border-color: #38bdf8; color: #38bdf8; }\n"
            "QListWidget#NavList::item:selected { background-color: qlineargradient(x1:0, y1:0, x2:1, y2:0, stop:0 #0284c7, stop:1 #0f172a); border-left: 3px solid #0ea5e9; color: #ffffff; font-weight: bold; }\n"
            "QPushButton#BtnReload { background-color: transparent; color: #38bdf8; border: 1px solid #0284c7; border-radius: 4px; font-weight: bold; font-size: 11px; font-family: 'Microsoft YaHei'; }\n"
            "QPushButton#BtnReload:hover { background-color: rgba(14, 165, 233, 0.1); border-color: #38bdf8; color: white; }\n"
            "QPushButton#BtnWinMin, QPushButton#BtnWinMax, QPushButton#BtnWinClose { background: transparent; border: none; color: #64748b; font-family: 'Segoe UI', sans-serif; font-size: 12px; font-weight: bold; border-radius: 4px; }\n"
            "QPushButton#BtnWinMin:hover, QPushButton#BtnWinMax:hover { background-color: #1e293b; color: #38bdf8; }\n"
            "QPushButton#BtnWinClose:hover { background-color: #ef4444; color: white; }"
        )
